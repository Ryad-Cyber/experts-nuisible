...
// Liens représentatifs de toute l'activité (services + nuisible phare + pages
// locales) — meilleur maillage interne SEO que la seule liste des 6 services.
const footerLinks = [
  ...
  { label: "Nuisibles volants", href: "/services/nuisibles-volants" },
  { label: "Professionnels", href: "/services/professionnels" },
  { label: "Punaises de lit", href: "/nuisibles/punaises" },
  { label: "Anti-nuisibles à Auxerre", href: "/zones-intervention/auxerre" },
  { label: "Anti-nuisibles à Sens", href: "/zones-intervention/sens" },
];
    ...
    <footer className="relative overflow-hidden bg-primary-dark text-white">
      ...
      <Container className="relative grid gap-8 py-8 md:py-10 lg:grid-cols-[1.6fr_1fr_1fr_1.3fr]">
        ...
        <div className="space-y-3.5">
          ...
          <p className="max-w-sm text-sm leading-relaxed text-white/65">{siteConfig.footerAbout}</p>
          <a
