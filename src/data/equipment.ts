...
export const SPECIALIZED_TOOLS: SpecializedTool[] = [
  ...
  },
  {
    ...
    image: "/perche.jpg",
    alt: "Perche télescopique professionnelle utilisée pour traiter les nids en hauteur",
  ...
  },
  {
    id: "kit-complet",
    label: "Kit complet",
    name: "Kit de matériel professionnel",
    image: "/kits.jpg",
    alt: "Kit de matériel professionnel de traitement (pulvérisateurs, perche, accessoires)",
    why: "Un ensemble d'outils et d'accessoires professionnels, adaptés et combinés selon le nuisible et la configuration du lieu.",
    benefit: "Chaque intervention est équipée avec le matériel réellement nécessaire, sans improvisation.",
  },
  {
